...
class OpportunityService:
    ...
    async def list_opportunities(self, filters: OpportunityFilter, skip: int, limit: int):
        ...
        return await self.repo.list(filters=filters, skip=skip, limit=limit)

    async def get_opportunity(self, id: UUID):
    ...
    async def update_opportunity(self, id: UUID, data: OpportunityUpdate):
